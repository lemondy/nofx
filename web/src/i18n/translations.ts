...
export const translations = {
  en: {
    ...
    candidateCoinsThisCycle: 'Candidates this cycle',
    standingBy: 'Standing by',
    confidence: 'Confidence',
    dataPage: {
      cryptoTrending: 'Crypto Trending',
      hlUniverse: 'Hyperliquid Universe',
      ai500: 'AI500 Picks',
      prediction: 'Prediction Markets',
      tabNetFlow: 'Net Flow',
      flowUnavailable: 'Net flow data is temporarily unavailable — auto-retrying every minute…',
      tabOI: 'Open Interest',
      tabDepth: 'Orderbook Depth',
      tabRates: 'Funding Rates',
      tabPrice: 'Top Movers',
      hlCrypto: 'Crypto',
      hlStocks: 'Stocks',
      hlPreIPO: 'Pre-IPO',
      hlIndices: 'Indices',
      hlCommodities: 'Commodities',
      hlFx: 'FX',
      topInflow: 'Top Inflow',
      bottomOutflow: 'Top Outflow',
      symbol: 'Symbol',
      price: 'Price',
      priceChange: 'Change',
      netFlow: 'Net Flow',
      futureFlow: 'Futures Flow',
      ...
      noData: 'No data',
      sourceNote: 'Data source: vergex.trade trending · refreshed every minute',
      breakoutRanking: 'Breakout Signals',
      breakoutNote: 'Piggy Dash engine · refreshed every 5 min',
      pattern: 'Pattern',
      pattern_breakout: 'Breakout',
      pattern_retest_hold: 'Retest Hold',
      pattern_extended: 'Extended',
      pattern_approach: 'Approach',
      percentile: 'Pct Rank',
      regime_btc_bull: 'BTC Bull',
      regime_btc_bear: 'BTC Bear',
      regime_chop: 'BTC Chop',
      tuning: 'Auto-tuned every 3 days from backtests',
      direction: 'Direction',
      score: 'Score',
      grade: 'Grade',
      grade_strong: 'Strong',
      ...
      grade_noise: 'Noise',
      keyLevel: 'Key Level',
      resonance: 'Multi-timeframe resonance',
      shortScanRanking: 'Short-Scan Ranking',
      shortScanNote: 'Short-scan engine · refreshed every 5 min',
      universe: 'Universe',
      universe_gainer: '24h Gainers',
      universe_near_high: 'Grinding Top',
      universe_hist_gainer: 'History Pump',
      confirmed: 'Confirmed',
      fundingAnn: 'Funding Ann.',
      lsRatio: 'L/S',
      oiValue: 'OI',
    },
    ...
    reviewPage: {
      title: 'Trade Review',
      subtitle: 'Structured trade journal → extract rules from lessons → pre-trade rule checks. A decision support system built from your own trade history.',
      trader: 'Trader',
      noTraders: 'No traders found. Create a trader first.',
      tabJournal: 'Trade Journal',
      tabStats: 'Statistics',
      tabRules: 'Rule System',
      tabAI: 'AI Review',
      filterAll: 'All',
      filterPending: 'Pending review',
      filterReviewed: 'Reviewed',
      filterSymbolPlaceholder: 'Symbol filter',
      totalCount: '{count} trades',
      syncing: 'Syncing...',
      syncFromPositions: 'Sync from positions',
      emptyJournal: 'No trade journal entries yet. Closed positions are synced automatically, or click "Sync from positions".',
      colSymbol: 'Symbol',
      ...
      colPnlPct: 'Return',
      colTime: 'Entry → Exit',
      colPlan: 'Planned SL/TP',
      colAdherence: 'Executed as plan',
      colEmotion: 'Emotion',
      colStatus: 'Status',
      colConfidence: 'AI confidence',
      colQuantity: 'Quantity',
      colPositionSize: 'Position size (USDT)',
      long: 'Long',
      short: 'Short',
      ...
      entryReasoning: 'Entry reasoning (captured at open)',
      executedAsPlan: 'Executed as planned?',
      adherenceYes: 'Fully followed',
      adherence_yes: 'Fully followed',
      adherence_partial: 'Partially deviated',
      adherence_no: 'Deviated',
      adherencePartial: 'Partially deviated',
      adherenceNo: 'Deviated',
      emotionState: 'Emotional state at entry (multi-select)',
      emotion_calm: 'Calm execution',
      emotion_fomo: 'FOMO chasing',
      emotion_fear_of_missing: 'Fear of missing out',
      emotion_revenge: 'Revenge trading',
      emotion_overconfident: 'Overconfident',
      emotion_hesitant: 'Hesitant',
      mistakeCategory: 'Failure category',
      mistake_strategy: 'Strategy flaw',
      mistake_execution: 'Execution discipline',
      mistake_risk_control: 'Risk control',
      mistake_market: 'Market conditions',
      mistake_none: 'No mistake',
      ...
      strategy_scalp: 'Scalping',
      strategy_news: 'News driven',
      strategy_other: 'Other',
      deviationNote: 'Deviation details (added positions, early exit, held past stop...)',
      deviationNotePlaceholder: 'What exactly deviated from the plan?',
      lesson: 'Lesson learned',
      lessonPlaceholder: 'One actionable lesson from this trade',
      saveReview: 'Save review',
      emptyStats: 'No statistics yet. Review trades in the Trade Journal tab first.',
      totalTrades: 'Total trades',
      reviewedCount: 'reviewed',
      winRate: 'Win rate',
      plRatio: 'P/L ratio',
      expectancy: 'Expectancy (USDT/trade)',
      expectancyDesc: 'The core metric: is the strategy worth running?',
      profitFactor: 'Profit factor',
      totalPnL: 'Total PnL',
      adherenceSection: 'Execution layer — plan adherence',
      emotionSection: 'Emotion vs outcome',
      mistakeSection: 'Failure categories',
      strategySection: 'Strategy layer — by type',
      planCoverage: 'Plan coverage: with SL/TP plan vs without',
      withPlanWinRate: 'With plan: {rate}% ({count})',
      noPlanWinRate: 'Without: {rate}% ({count})',
      noData: 'No data — review more trades',
      groupCol: 'Group',
      countCol: 'Trades',
      winRateCol: 'Win rate',
      totalPnlCol: 'Total PnL',
      avgPnlCol: 'Avg PnL',
      rulesIntro: 'Hard rules are machine-checked before every order (violations are blocked or warned). Soft lessons are injected into the AI prompt as guidance.',
      aiExtractRules: 'AI extract rules',
      extracting: 'Analyzing...',
      addRule: 'Add rule',
      aiProposals: 'AI proposed rules',
      applyAll: 'Save all',
      noProposals: 'AI found no new rules worth adding. Review more trades first.',
      rulesApplied: 'Saved {count} rules',
      hardRules: 'Hard rules (pre-trade program check)',
      softRules: 'Soft lessons (AI prompt guidance)',
      noHardRules: 'No hard rules yet. Use "AI extract rules" or add one manually.',
      noSoftRules: 'No soft lessons yet.',
      checkLogs: 'Pre-trade check logs',
      noCheckLogs: 'No rule checks fired yet. Logs appear when the AI tries to open a position.',
      ruleName: 'Rule name',
      ruleNameRequired: 'Rule name is required',
      ruleCondition: 'Condition',
      violationAction: 'On violation',
      violationBlock: 'Block order',
      violationWarn: 'Warn only',
      ruleDescription: 'Description',
      ruleHits: '{hits} fired / {blocks} blocked',
      enabled: 'Enabled',
      disabled: 'Disabled',
      saveRule: 'Save rule',
      typeHard: 'Hard rule',
      typeSoft: 'Soft lesson',
      lessonText: 'Lesson text',
      ruleTags: 'Tags (comma separated)',
      colRuleName: 'Rule',
      ruleNameCol: 'Rule',
      checkResult: 'Result',
      resultBlocked: 'Blocked',
      resultWarned: 'Warned',
      aiReviewIntro: 'AI reviews your journal across three layers — strategy (is the method sound), execution (did you follow your plan) and statistics (win rate / P&L ratio / expectancy / drawdown) — then proposes concrete rules for the next period.',
      period_daily: 'Daily',
      period_weekly: 'Weekly',
      period_monthly: 'Monthly',
      aiRunReview: 'Run AI review',
      aiRunning: 'Reviewing...',
      aiReviewResult: 'AI review report',
      promptSettings: 'Prompt Settings',
      promptReview: 'Review prompt (system)',
      promptRuleExtract: 'Rule-extraction prompt (system)',
      promptCustomActive: 'Custom',
      promptUsingDefault: 'Built-in default — edit and save to override',
      promptSave: 'Save Prompts',
      promptSaved: 'Prompt saved — applies to the next AI review',
      promptReset: 'Restore Default',
      promptResetHint: 'Empty text = built-in default',
      promptLoadFail: 'Failed to load prompt settings',    },
  ...
  zh: {
    ...
    // Data Page
    dataCenter: '数据中心',
    candidateCoinsThisCycle: '本周期候选币种',
    standingBy: '观望',
    confidence: '置信度',
    dataPage: {
      cryptoTrending: '加密趋势',
      hlUniverse: 'Hyperliquid 品种',
      ai500: 'AI500 精选',
      prediction: '预测市场',
      tabNetFlow: '净流入',
      flowUnavailable: '净流入数据暂时不可用，每分钟自动重试…',
      tabOI: '持仓量',
      tabDepth: '盘口深度',
      tabRates: '资金费率',
      tabPrice: '涨跌幅榜',
      ...
      totalRows: '共 {count} 条',
      noData: '暂无数据',
      sourceNote: '数据来源：vergex.trade trending · 每分钟自动刷新',
      breakoutRanking: '突破信号榜',
      breakoutNote: '猪猪冲刺引擎 · 每 5 分钟刷新',
      pattern: '形态',
      pattern_breakout: '突破',
      pattern_retest_hold: '回踩企稳',
      pattern_extended: '延伸',
      pattern_approach: '接近',
      percentile: '横截面百分位',
      regime_btc_bull: 'BTC 多头',
      regime_btc_bear: 'BTC 空头',
      regime_chop: 'BTC 震荡',
      tuning: '每 3 天基于回测自动微调',
      direction: '方向',
      score: '得分',
      grade: '等级',
      grade_strong: '强',
      ...
      keyLevel: '关键位',
      resonance: '多周期共振',
      shortScanRanking: '做空扫描榜',
      shortScanNote: '做空扫描引擎 · 每 5 分钟刷新',
      universe: '宇宙',
      universe_gainer: '24h涨幅榜',
      universe_near_high: '磨顶近高点',
      universe_hist_gainer: '历史涨幅池',
      confirmed: '已确认',
      fundingAnn: '费率年化',
      lsRatio: '多空比',
      oiValue: '持仓量',
    ...
    reviewPage: {
      title: '交易复盘',
      subtitle: '结构化交易日志 → 提炼教训为规则 → 下单前规则检查，用你自己的交易历史构建决策支持系统。',
      trader: '交易器',
      noTraders: '暂无交易器，请先创建一个。',
      tabJournal: '交易日志',
      tabStats: '统计分析',
      tabRules: '规则系统',
      tabAI: 'AI 复盘',
      ...
      filterPending: '待复盘',
      filterReviewed: '已复盘',
      filterSymbolPlaceholder: '按币种筛选',
      totalCount: '共 {count} 笔',
      syncing: '同步中...',
      syncFromPositions: '从持仓同步',
      emptyJournal: '暂无交易日志。已平仓的交易会自动同步，也可点击"从持仓同步"。',
      colSymbol: '币种',
      colDirection: '方向',
      colEntry: '开仓价',
      colExit: '平仓价',
      ...
      colEmotion: '情绪',
      colStatus: '状态',
      colConfidence: 'AI 置信度',
      colQuantity: '数量',
      colPositionSize: '仓位大小 (USDT)',
      long: '做多',
      short: '做空',
      noPlan: '未记录计划',
      reviewed: '已复盘',
      ...
      plannedSL: '计划止损价',
      plannedTP: '计划止盈价',
      entryReasoning: '开仓决策依据（开仓时记录）',
      executedAsPlan: '是否按计划执行？',
      adherenceYes: '完全执行',
      adherence_yes: '完全执行',
      adherence_partial: '部分偏离',
      adherence_no: '未按计划',
      adherencePartial: '部分偏离',
      adherenceNo: '未按计划',
      emotionState: '开仓时情绪状态（多选）',
      emotion_calm: '冷静执行',
      emotion_fomo: 'FOMO 追涨',
      emotion_fear_of_missing: '害怕踏空',
      emotion_revenge: '报复性交易',
      emotion_overconfident: '过度自信',
      emotion_hesitant: '犹豫不决',
      mistakeCategory: '失败原因分类',
      mistake_strategy: '策略问题',
      mistake_execution: '执行纪律',
      mistake_risk_control: '风险控制',
      mistake_market: '市场环境',
      mistake_none: '无明显错误',
      strategyTag: '策略类型',
      strategy_breakout: '突破策略',
      strategy_mean_reversion: '均值回归',
      strategy_trend_following: '趋势跟随',
      strategy_momentum: '动量追势',
      strategy_scalp: '短线刮头皮',
      strategy_news: '消息面驱动',
      strategy_other: '其他',
      deviationNote: '偏离细节（加仓、提前离场、扛单等）',
      deviationNotePlaceholder: '具体偏离了计划的哪些内容？',
      lesson: '学到的教训',
      lessonPlaceholder: '这笔交易给你的一条可执行教训',
      saveReview: '保存复盘',
      emptyStats: '暂无统计数据。请先在"交易日志"中复盘交易。',
      totalTrades: '总交易笔数',
      reviewedCount: '已复盘',
      winRate: '胜率',
      plRatio: '盈亏比',
      expectancy: '期望值 (USDT/笔)',
      expectancyDesc: '核心指标：策略是否值得长期做',
      profitFactor: '盈利因子',
      totalPnL: '总盈亏',
      adherenceSection: '执行层面 — 计划执行情况',
      emotionSection: '情绪与盈亏',
      mistakeSection: '失败原因分布',
      strategySection: '策略层面 — 按类型统计',
      planCoverage: '计划覆盖：有止损止盈计划 vs 无计划',
      withPlanWinRate: '有计划：{rate}%（{count} 笔）',
      noPlanWinRate: '无计划：{rate}%（{count} 笔）',
      noData: '暂无数据 — 复盘更多交易后显示',
      groupCol: '分组',
      countCol: '笔数',
      winRateCol: '胜率',
      totalPnlCol: '总盈亏',
      avgPnlCol: '平均盈亏',
      rulesIntro: '硬性规则在每笔下单前由程序自动校验（违规即拦截或警告）；软性教训会注入 AI 提示词作为决策参考。',
      aiExtractRules: 'AI 提炼规则',
      extracting: '分析中...',
      addRule: '新增规则',
      aiProposals: 'AI 提议的新规则',
      applyAll: '全部保存',
      noProposals: 'AI 认为暂无值得新增的规则。请先复盘更多交易。',
      rulesApplied: '已保存 {count} 条规则',
      hardRules: '硬性规则（下单前程序校验）',
      softRules: '软性教训（AI 提示词参考）',
      noHardRules: '暂无硬性规则。可使用"AI 提炼规则"或手动添加。',
      noSoftRules: '暂无软性教训。',
      checkLogs: '下单前检查日志',
      noCheckLogs: '暂无规则拦截记录。AI 尝试开仓并触发规则时会出现在这里。',
      ruleName: '规则名称',
      ruleNameRequired: '请填写规则名称',
      ruleCondition: '触发条件',
      violationAction: '违规处理',
      violationBlock: '拦截下单',
      violationWarn: '仅警告',
      ruleDescription: '规则说明',
      ruleHits: '触发 {hits} 次 / 拦截 {blocks} 次',
      enabled: '已启用',
      disabled: '已停用',
      saveRule: '保存规则',
      typeHard: '硬性规则',
      ...
      resultBlocked: '已拦截',
      resultWarned: '已警告',
      aiReviewIntro: 'AI 从三个层面复盘你的交易日志 — 策略层面（方法本身是否有问题）、执行层面（是否知行合一）、统计层面（胜率/盈亏比/期望值/最大回撤）— 并为下个周期提出具体可执行的规则。',
      period_daily: '每日',
      period_weekly: '每周',
      period_monthly: '每月',
      aiRunReview: '开始 AI 复盘',
      aiRunning: '复盘生成中...',
      aiReviewResult: 'AI 复盘报告',
      promptSettings: 'Prompt 设置',
      promptReview: '复盘 Prompt（系统提示词）',
      promptRuleExtract: '规则提炼 Prompt（系统提示词）',
      promptCustomActive: '自定义生效中',
      promptUsingDefault: '当前使用内置默认模板，编辑并保存即可覆盖',
      promptSave: '保存 Prompt',
      promptSaved: '已保存，下次 AI 复盘即生效',
      promptReset: '恢复默认',
      promptResetHint: '清空文本 = 使用内置默认',
      promptLoadFail: '加载 Prompt 设置失败',    },
  ...
  id: {
    ...
    // Data Page
    dataCenter: 'Data Center',
    candidateCoinsThisCycle: 'Kandidat siklus ini',
    standingBy: 'Menunggu',
    confidence: 'Keyakinan',
    dataPage: {
      cryptoTrending: 'Tren Kripto',
      hlUniverse: 'Universe Hyperliquid',
      ai500: 'Pilihan AI500',
      prediction: 'Pasar Prediksi',
      tabNetFlow: 'Arus Bersih',
      flowUnavailable: 'Data arus bersih sementara tidak tersedia — mencoba ulang otomatis setiap menit…',
      tabOI: 'Open Interest',
      tabDepth: 'Kedalaman Orderbook',
      tabRates: 'Tarif Pendanaan',
      tabPrice: 'Pergerakan Harga',
      hlCrypto: 'Kripto',
      hlStocks: 'Saham',
      hlPreIPO: 'Pre-IPO',
      hlIndices: 'Indeks',
      hlCommodities: 'Komoditas',
      hlFx: 'Forex',
      topInflow: 'Inflow Teratas',
      bottomOutflow: 'Outflow Teratas',
      symbol: 'Simbol',
      price: 'Harga',
      priceChange: 'Perubahan',
      netFlow: 'Arus Bersih',
      futureFlow: 'Arus Futures',
      currentOI: 'OI Saat Ini',
      oiChange: 'Perubahan OI',
      fundingRate: 'Tarif Pendanaan',
      funding: 'Pendanaan',
      ...
      askVol: 'Vol Ask',
      delta: 'Delta',
      futuresDepth: 'Kedalaman Futures',
      spotDepth: 'Kedalaman Spot',
      volume24h: 'Volume 24j',
      openInterest: 'Open Interest',
      maxLeverage: 'Lev. Maks',
      searchSymbol: 'Cari simbol...',
      totalRows: '{count} baris',
      noData: 'Tidak ada data',
      sourceNote: 'Sumber data: vergex.trade trending · diperbarui setiap menit',
      breakoutRanking: 'Sinyal Ruptura',
      breakoutNote: 'Mesin Cerdo Veloz · diperbarui tiap 5 menit',
      pattern: 'Pola',
      pattern_breakout: 'Ruptura',
      pattern_retest_hold: 'Retest Bertahan',
      pattern_extended: 'Extended',
      pattern_approach: 'Mendekat',
      percentile: 'Persentil',
      regime_btc_bull: 'BTC Bull',
      regime_btc_bear: 'BTC Bear',
      regime_chop: 'BTC Chop',
      tuning: 'Auto-tune tiap 3 hari dari backtest',
      direction: 'Arah',
      score: 'Skor',
      grade: 'Tingkat',
      grade_strong: 'Kuat',
      ...
      grade_weak: 'Pantau',
      grade_noise: 'Bising',
      keyLevel: 'Level Kunci',
      resonance: 'Resonansi multi-timeframe',
    },
    ...
    reviewPage: {
      ...
      subtitle: 'Jurnal trading terstruktur → ekstrak pelajaran menjadi aturan → pemeriksaan aturan sebelum order. Sistem pendukung keputusan dari riwayat trading Anda.',
      trader: 'Trader',
      noTraders: 'Belum ada trader. Buat trader terlebih dahulu.',
      tabJournal: 'Jurnal Trading',
      tabStats: 'Statistik',
      tabRules: 'Sistem Aturan',
      tabAI: 'Review AI',
      filterAll: 'Semua',
      filterPending: 'Menunggu review',
      filterReviewed: 'Sudah direview',
      filterSymbolPlaceholder: 'Filter simbol',
      totalCount: '{count} transaksi',
      syncing: 'Menyinkronkan...',
      syncFromPositions: 'Sinkron dari posisi',
      emptyJournal: 'Belum ada jurnal. Posisi yang ditutup disinkronkan otomatis, atau klik "Sinkron dari posisi".',
      colSymbol: 'Simbol',
      colDirection: 'Arah',
      colEntry: 'Harga Masuk',
      colExit: 'Harga Keluar',
      colLeverage: 'Leverage',
      colPnL: 'PnL (USDT)',
      colPnlPct: 'Imbal Hasil',
      colTime: 'Masuk → Keluar',
      colPlan: 'Rencana SL/TP',
      colAdherence: 'Sesuai rencana',
      colEmotion: 'Emosi',
      colStatus: 'Status',
      colConfidence: 'Keyakinan AI',
      colQuantity: 'Kuantitas',
      long: 'Long',
      short: 'Short',
      noPlan: 'Tidak ada rencana',
      reviewed: 'Direview',
      pendingReview: 'Menunggu',
      reviewAction: 'Review',
      plannedSL: 'Stop-loss rencana',
      plannedTP: 'Take-profit rencana',
      entryReasoning: 'Alasan entry (dicatat saat membuka posisi)',
      executedAsPlan: 'Dieksekusi sesuai rencana?',
      adherenceYes: 'Sepenuhnya',
      adherence_yes: 'Sepenuhnya',
      adherence_partial: 'Sebagian menyimpang',
      adherence_no: 'Tidak sesuai',
      adherencePartial: 'Sebagian menyimpang',
      adherenceNo: 'Tidak sesuai',
      emotionState: 'Kondisi emosi saat entry (pilih beberapa)',
      emotion_calm: 'Tenang',
      emotion_fomo: 'FOMO mengejar',
      emotion_fear_of_missing: 'Takut ketinggalan',
      emotion_revenge: 'Trading balas dendam',
      emotion_overconfident: 'Terlalu percaya diri',
      emotion_hesitant: 'Ragu-ragu',
      mistakeCategory: 'Kategori kegagalan',
      mistake_strategy: 'Cacat strategi',
      mistake_execution: 'Disiplin eksekusi',
      mistake_risk_control: 'Kontrol risiko',
      mistake_market: 'Kondisi pasar',
      mistake_none: 'Tanpa kesalahan',
      strategyTag: 'Tipe strategi',
      strategy_breakout: 'Breakout',
      strategy_mean_reversion: 'Mean reversion',
      strategy_trend_following: 'Trend following',
      strategy_momentum: 'Momentum',
      strategy_scalp: 'Scalping',
      strategy_news: 'Berita',
      strategy_other: 'Lainnya',
      deviationNote: 'Detail penyimpangan (tambah posisi, keluar cepat, menahan loss...)',
      deviationNotePlaceholder: 'Apa saja yang menyimpang dari rencana?',
      lesson: 'Pelajaran',
      lessonPlaceholder: 'Satu pelajaran yang bisa dieksekusi dari transaksi ini',
      saveReview: 'Simpan review',
      emptyStats: 'Belum ada statistik. Review transaksi di tab Jurnal terlebih dahulu.',
      totalTrades: 'Total transaksi',
      reviewedCount: 'direview',
      winRate: 'Win rate',
      plRatio: 'Rasio P/L',
      expectancy: 'Ekspektasi (USDT/transaksi)',
      expectancyDesc: 'Metrik inti: apakah strategi layak dijalankan?',
      profitFactor: 'Profit factor',
      totalPnL: 'Total PnL',
      adherenceSection: 'Lapisan eksekusi — kepatuhan rencana',
      emotionSection: 'Emosi vs hasil',
      mistakeSection: 'Kategori kegagalan',
      strategySection: 'Lapisan strategi — per tipe',
      planCoverage: 'Cakupan rencana: dengan SL/TP vs tanpa',
      withPlanWinRate: 'Dengan rencana: {rate}% ({count})',
      noPlanWinRate: 'Tanpa: {rate}% ({count})',
      noData: 'Belum ada data — review lebih banyak transaksi',
      groupCol: 'Grup',
      countCol: 'Transaksi',
      winRateCol: 'Win rate',
      totalPnlCol: 'Total PnL',
      avgPnlCol: 'Rata-rata PnL',
      rulesIntro: 'Aturan keras diperiksa program sebelum setiap order (pelanggaran diblokir atau diperingatkan). Pelajaran lunak dimasukkan ke prompt AI sebagai panduan.',
      aiExtractRules: 'Ekstrak aturan dengan AI',
      extracting: 'Menganalisis...',
      addRule: 'Tambah aturan',
      aiProposals: 'Aturan usulan AI',
      applyAll: 'Simpan semua',
      noProposals: 'AI tidak menemukan aturan baru yang layak. Review lebih banyak transaksi dulu.',
      rulesApplied: '{count} aturan disimpan',
      hardRules: 'Aturan keras (pemeriksaan program sebelum order)',
      softRules: 'Pelajaran lunak (panduan prompt AI)',
      noHardRules: 'Belum ada aturan keras. Gunakan "Ekstrak aturan dengan AI" atau tambah manual.',
      noSoftRules: 'Belum ada pelajaran lunak.',
      checkLogs: 'Log pemeriksaan sebelum order',
      noCheckLogs: 'Belum ada pemeriksaan. Log muncul saat AI mencoba membuka posisi.',
      ruleName: 'Nama aturan',
      ruleNameRequired: 'Nama aturan wajib diisi',
      ruleCondition: 'Kondisi',
      violationAction: 'Saat pelanggaran',
      violationBlock: 'Blokir order',
      violationWarn: 'Hanya peringatan',
      ruleDescription: 'Deskripsi',
      ruleHits: '{hits} terpicu / {blocks} diblokir',
      enabled: 'Aktif',
      disabled: 'Nonaktif',
      saveRule: 'Simpan aturan',
      typeHard: 'Aturan keras',
      typeSoft: 'Pelajaran lunak',
      lessonText: 'Isi pelajaran',
      ruleTags: 'Tag (pisahkan dengan koma)',
      checkResult: 'Hasil',
      resultBlocked: 'Diblokir',
      resultWarned: 'Diperingatkan',
      aiReviewIntro: 'AI mereview jurnal Anda dalam tiga lapisan — strategi (apakah metode benar), eksekusi (apakah sesuai rencana), statistik (win rate / rasio P/L / ekspektasi / drawdown) — lalu mengusulkan aturan konkret untuk periode berikutnya.',
      period_daily: 'Harian',
      period_weekly: 'Mingguan',
      period_monthly: 'Bulanan',
      aiRunReview: 'Jalankan review AI',
      aiRunning: 'Menyusun review...',
      aiReviewResult: 'Laporan review AI',
      promptSettings: 'Pengaturan Prompt',
      promptReview: 'Prompt review (sistem)',
      promptRuleExtract: 'Prompt ekstraksi aturan (sistem)',
      promptCustomActive: 'Kustom aktif',
      promptUsingDefault: 'Menggunakan template bawaan — edit dan simpan untuk menimpa',
      promptSave: 'Simpan Prompt',
      promptSaved: 'Tersimpan — berlaku untuk review AI berikutnya',
      promptReset: 'Kembalikan Default',
      promptResetHint: 'Teks kosong = bawaan',
      promptLoadFail: 'Gagal memuat pengaturan prompt',    },

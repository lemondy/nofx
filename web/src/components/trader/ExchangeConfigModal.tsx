...
const SUPPORTED_EXCHANGE_TEMPLATES = [
 ...
 { exchange_type: 'binance_stocks', name: 'Binance Stocks (美股)', type: 'stock' as const },
...
function StepIndicator({ currentStep, labels }: { currentStep: number; labels: string[] }) {
 ...
 style={{
 background: index < currentStep ? '#2E7D4F' : index === currentStep ? '#B8912A' : '#C0B9A2',
...
function ExchangeCard({
 ...
 style={{
 background: template.type === 'cex' ? 'rgba(184, 145, 42, 0.2)' : 'rgba(139, 92, 246, 0.2)',
...
export function ExchangeConfigModal({
 ...
 <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide" style={{ color: '#6E6E60' }}>
 ...
 <div className="text-xs font-medium uppercase tracking-wide" style={{ color: '#B8912A' }}>
 ...
 style={{ background: 'rgba(184, 145, 42, 0.1)', border: '1px solid rgba(184, 145, 42, 0.3)' }}
 >
 ...
 <span className="text-xs px-1.5 py-0.5 rounded" style={{ background: 'rgba(46, 125, 79, 0.2)', color: '#2E7D4F' }}>
 ...
 {currentExchangeType === 'binance' && (
 <div className="p-4 rounded-xl" style={{ background: 'rgba(184, 145, 42, 0.1)', border: '1px solid rgba(184, 145, 42, 0.2)' }}>
 <div className="text-sm font-semibold mb-2" style={{ color: '#B8912A' }}>
 {t('whitelistIP', language)}
 </div>
 <div className="text-xs mb-3" style={{ color: '#6E6E60' }}>
 {t('whitelistIPDesc', language)}
 </div>
 {loadingIP ? (
 <div className="text-xs" style={{ color: '#6E6E60' }}>{t('loadingServerIP', language)}</div>
 ) : serverIP?.public_ip ? (
 <div className="flex items-center gap-2 p-3 rounded-lg" style={{ background: '#F2EFE6' }}>
 <code className="flex-1 text-sm font-mono" style={{ color: '#B8912A' }}>{serverIP.public_ip}</code>
 <button
 type="button"
 onClick={() => handleCopyIP(serverIP.public_ip)}
 className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all hover:scale-105"
 style={{ background: 'rgba(184, 145, 42, 0.2)', color: '#B8912A' }}
 >
 ...
 <div className="text-xs" style={{ color: '#6E6E60' }}>{t('asterApiProDesc', language)}</div>
 </div>
 </div>
 </div>
 <div className="space-y-2">
 ...
 <input type="text" value={asterUser} onChange={(e) => setAsterUser(e.target.value)} placeholder={t('enterAsterUser', language)} className="w-full px-4 py-3 rounded-xl" style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#1E1E1A' }} required />
 </div>
 <div className="space-y-2">
 <label className="flex items-center gap-2 text-sm font-semibold" style={{ color: '#1E1E1A' }}>
 ...
 <input type="text" value={asterSigner} onChange={(e) => setAsterSigner(e.target.value)} placeholder={t('enterAsterSigner', language)} className="w-full px-4 py-3 rounded-xl" style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#1E1E1A' }} required />
 </div>
 <div className="space-y-2">
 <label className="flex items-center gap-2 text-sm font-semibold" style={{ color: '#1E1E1A' }}>
 ...
 <input type="password" value={asterPrivateKey} onChange={(e) => setAsterPrivateKey(e.target.value)} placeholder={t('enterAsterPrivateKey', language)} className="w-full px-4 py-3 rounded-xl" style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#1E1E1A' }} required />
 </div>
 </>
 )}
 ...
 <div className="text-xs" style={{ color: '#6E6E60' }}>{t('hyperliquidAgentWalletDesc', language)}</div>
 </div>
 </div>
 </div>
 <div className="space-y-2">
 <label className="text-sm font-semibold" style={{ color: '#1E1E1A' }}>{t('hyperliquidAgentPrivateKey', language)}</label>
 <div className="flex gap-2">
 <input type="text" value={maskSecret(apiKey)} readOnly placeholder={t('enterHyperliquidAgentPrivateKey', language)} className="flex-1 px-4 py-3 rounded-xl" style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#1E1E1A' }} />
 ...
 <div className="space-y-2">
 <label className="text-sm font-semibold" style={{ color: '#1E1E1A' }}>{t('hyperliquidMainWalletAddress', language)}</label>
 <input type="text" value={hyperliquidWalletAddr} onChange={(e) => setHyperliquidWalletAddr(e.target.value)} placeholder={t('enterHyperliquidMainWalletAddress', language)} className="w-full px-4 py-3 rounded-xl" style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#1E1E1A' }} required />
 </div>
 </>
 )}
 ...
 <div className="space-y-2">
 <label className="text-sm font-semibold" style={{ color: '#1E1E1A' }}>{t('lighterWalletAddress', language)} *</label>
 <input type="text" value={lighterWalletAddr} onChange={(e) => setLighterWalletAddr(e.target.value)} placeholder={t('enterLighterWalletAddress', language)} className="w-full px-4 py-3 rounded-xl" style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#1E1E1A' }} required />
 </div>
 <div className="space-y-2">
 <label className="flex items-center gap-2 text-sm font-semibold" style={{ color: '#1E1E1A' }}>
 ...
 <input type="password" value={lighterApiKeyPrivateKey} onChange={(e) => setLighterApiKeyPrivateKey(e.target.value)} placeholder={t('enterLighterApiKeyPrivateKey', language)} className="w-full px-4 py-3 rounded-xl font-mono" style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#1E1E1A' }} required />
 </div>
 <div className="space-y-2">
 <label className="flex items-center gap-2 text-sm font-semibold" style={{ color: '#1E1E1A' }}>
 ...
 <input type="number" min={0} max={255} value={lighterApiKeyIndex} onChange={(e) => setLighterApiKeyIndex(parseInt(e.target.value) || 0)} className="w-full px-4 py-3 rounded-xl" style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#1E1E1A' }} />
 </div>
 </>
 )}
 ...
 <button type="button" onClick={handleBack} className="flex-1 px-4 py-3 rounded-xl text-sm font-semibold transition-all hover:bg-[#1E1E1A]/5" style={{ background: '#C0B9A2', color: '#6E6E60' }}>
 ...
 {/* Binance Guide Modal */}
 {showGuide && (
 <div className="fixed inset-0 bg-[#F2EFE6]/75 flex items-center justify-center z-50 p-4" onClick={() => setShowGuide(false)}>
 <div className="rounded-2xl p-6 w-full max-w-4xl" style={{ background: '#E9E4D6' }} onClick={(e) => e.stopPropagation()}>
 <div className="flex items-center justify-between mb-4">
 <h3 className="text-xl font-bold flex items-center gap-2" style={{ color: '#1E1E1A' }}>
 <BookOpen className="w-6 h-6" style={{ color: '#B8912A' }} />
 {t('binanceSetupGuide', language)}
 </h3>
 <button onClick={() => setShowGuide(false)} className="px-4 py-2 rounded-lg text-sm font-semibold" style={{ background: '#C0B9A2', color: '#6E6E60' }}>

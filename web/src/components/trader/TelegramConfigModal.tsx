...
function StepIndicator({ currentStep, labels }: { currentStep: number; labels: string[] }) {
 ...
 style={{
 background: index < currentStep ? '#2E7D4F' : index === currentStep ? '#2AABEE' : '#C0B9A2',
...
export function TelegramConfigModal({ onClose, language }: TelegramConfigModalProps) {
 ...
 style={{ background: '#F2EFE6', border: '1px solid #C0B9A2', color: '#6E6E60' }}
 >
 ...
 style={{ background: 'linear-gradient(180deg, #E9E4D6 0%, #EDE9DC 100%)' }}
 >
 {/* Header */}
 ...
 <div
 className="p-4 rounded-xl space-y-3"
 style={{ background: 'rgba(46, 125, 79, 0.1)', border: '1px solid rgba(46, 125, 79, 0.3)' }}
 >
 <div className="flex items-start gap-3">
 <span className="text-2xl">📱</span>
 <div>
 <div className="font-semibold mb-1" style={{ color: '#2E7D4F' }}>
 ...
 <div>
 <div className="text-xs font-mono" style={{ color: '#6E6E60' }}>
 {t('telegram.currentToken', language)}
 </div>
 <div className="text-sm font-mono" style={{ color: '#1E1E1A' }}>
 {config.token_masked}
 </div>
 </div>
 </div>
 ...
 style={{ background: 'rgba(184, 145, 42, 0.08)', border: '1px solid rgba(184, 145, 42, 0.2)' }}
 >
 ...
 <div className="font-bold text-lg" style={{ color: '#2E7D4F' }}>
 ...
 <div className="text-sm font-mono truncate" style={{ color: '#1E1E1A' }}>
 {config.token_masked}
 </div>
 </div>
 </div>
 ...
 style={{ background: '#F2EFE6', border: '1px solid #C0B9A2' }}
 >
 <div className="text-xs font-semibold uppercase tracking-wide mb-2" style={{ color: '#6E6E60' }}>
 ...
 <code className="font-mono px-1.5 py-0.5 rounded flex-shrink-0" style={{ background: '#E9E4D6', color: '#2AABEE' }}>
 {item.cmd}
 </code>

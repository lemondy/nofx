...
export function SetupPage() {
 ...
 {[...Array(4)].map((_, i) => (
 <div key={i} className="h-24 rounded-xl border border-nofx-line bg-[#1E1E1A]/5" />
 ))}
 </div>
 ...
 <img src="/icons/nofx.svg" alt="NOFX" className="w-14 h-14 relative z-10 drop-shadow-[0_0_15px_rgba(184,145,42,0.3)]" />
 </div>
 </div>
 <h1 className="text-2xl font-bold text-[#1E1E1A] mb-1.5">{l.welcome}</h1>
 ...
 {/* Email */}
 <div>
 <label className="block text-xs font-medium text-[#6E6E60] mb-2">{l.email}</label>
 <input
 type="email"
 value={email}
 ...
 {/* Password */}
 <div>
 <label className="block text-xs font-medium text-[#6E6E60] mb-2">{l.password}</label>
 <div className="relative">
 <input

...
export default function BrandStats() {
 ...
 className="relative overflow-hidden group bg-[#ECE8DB] border border-nofx-line p-6 rounded-lg md:bg-transparent md:border-0 md:p-0"
 >
 {/* Mobile Neon Corners */}
 ...
 <div className="text-3xl md:text-6xl font-black text-[#1E1E1A] tracking-tighter mb-2 group-hover:scale-110 transition-transform duration-300 origin-left relative z-10">
 {stat.value}
 </div>
 <div className="text-[10px] md:text-base font-bold text-[#6E6E60] md:text-black/60 uppercase tracking-widest bg-[#1E1E1A]/5 md:bg-[#1E1E1A]/15 inline-block px-2 py-1 rounded relative z-10">
 {stat.label}
 </div>
 </motion.div>
 ))}

...
export default function AgentTerminal() {
 ...
 <span className="text-[#6E6E60] text-xs font-mono">NOFX Agent Terminal</span>
 </div>
 {/* Live indicator */}
 ...
 <span className="text-[#6E6E60] text-xs font-mono uppercase tracking-wider">Portfolio PnL</span>
 ...
 <button className="px-2 py-0.5 text-[10px] text-[#8A8A7C] font-mono hover:text-[#6E6E60] transition-colors">7D</button>
 <button className="px-2 py-0.5 text-[10px] text-[#8A8A7C] font-mono hover:text-[#6E6E60] transition-colors">30D</button>
 </div>
 </div>
 ...
 <div className="text-[#6E6E60] text-[10px] font-mono uppercase tracking-wider mb-1">OI</div>
 <div className="text-[#1E1E1A] font-bold font-mono">$847M</div>
 <div className="text-green-500 text-[10px] font-mono">↑ 2.1%</div>
 </div>
 <div className="p-3 text-center">
 <div className="text-[#6E6E60] text-[10px] font-mono uppercase tracking-wider mb-1">Netflow</div>
 <div className="text-green-400 font-bold font-mono">+$124M</div>
 <div className="text-[#6E6E60] text-[10px] font-mono">24h inflow</div>
 </div>
 <div className="p-3 text-center">
 <div className="text-[#6E6E60] text-[10px] font-mono uppercase tracking-wider mb-1">L/S Ratio</div>
 ...
 <div className="p-4 border-b border-[#C0B9A2]/40">
 <div className="flex items-center justify-between mb-3">
 <span className="text-[#6E6E60] text-xs font-mono uppercase tracking-wider">Order Book</span>
 <span className="text-[#8A8A7C] text-[10px] font-mono">Spread: <span className="text-nofx-gold">0.02%</span></span>
 </div>
 ...
 <span className="relative text-[#6E6E60] font-mono">{ask.amount}</span>
 </div>
 ))}
 </div>
 {/* Bids */}
 ...
 <span className="relative text-[#6E6E60] font-mono">{bid.amount}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="p-4">
 <div className="flex items-center justify-between mb-3">
 <span className="text-[#6E6E60] text-xs font-mono uppercase tracking-wider">Positions</span>
 ...
 <div key={i} className="flex items-center justify-between py-2 px-2 rounded-lg bg-[#ECE8DB]/50 hover:bg-[#E4E0D0]/50 transition-colors">
 ...
 <div>
 <div className="text-[#1E1E1A] text-sm font-mono">{pos.name}</div>
 <div className="flex items-center gap-2 text-[10px]">
 <span className="text-green-400 bg-green-500/10 px-1.5 py-0.5 rounded font-mono">LONG</span>
 <span className="text-[#6E6E60] font-mono">{pos.size} {pos.coin}</span>
 </div>
 </div>
 </div>

...
export function ResetPasswordPage() {
 ...
 return (
 <div className="min-h-screen" style={{ background: '#F2EFE6' }}>
 <Header simple />
 ...
 className="flex items-center gap-2 mb-6 text-sm hover:text-[#B8912A] transition-colors"
 style={{ color: '#6E6E60' }}
 >
 ...
 >
 <KeyRound className="w-8 h-8" style={{ color: '#B8912A' }} />
 </div>
 <h1 className="text-2xl font-bold" style={{ color: '#1E1E1A' }}>
 {t('resetPasswordTitle', language)}
 </h1>
 <p className="text-sm mt-2" style={{ color: '#6E6E60' }}>
 使用邮箱和新密码重置账户密码
 </p>
 </div>
 ...
 <p className="text-sm" style={{ color: '#6E6E60' }}>
 3秒后将自动跳转到登录页面...
 </p>
 </div>
 ) : (

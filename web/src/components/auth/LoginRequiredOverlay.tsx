...
export function LoginRequiredOverlay({ isOpen, onClose, featureName }: LoginRequiredOverlayProps) {
 ...
 >
 <DeepVoidBackground
 className="w-full h-full bg-nofx-bg/95 flex items-center justify-center p-4 text-nofx-text"
 disableAnimation
 onClick={onClose}
 >
 ...
 <h2 className="text-xl font-bold text-[#1E1E1A] uppercase tracking-wider mb-2">{tr('title')}</h2>

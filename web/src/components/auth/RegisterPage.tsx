...
export function RegisterPage() {
 ...
 <div>
 <label className="block text-xs uppercase tracking-wider text-[#6E6E60] mb-1.5 ml-1 font-bold">{t('email', language)}</label>
 <input
 type="email"
 value={email}
 ...
 <div>
 <label className="block text-xs uppercase tracking-wider text-[#6E6E60] mb-1.5 ml-1 font-bold">{t('password', language)}</label>
 <div className="relative">
 <input
 ...
 <div>
 <label className="block text-xs uppercase tracking-wider text-[#6E6E60] mb-1.5 ml-1 font-bold">{t('confirmPassword', language)}</label>
 <div className="relative">
 <input
 ...
 required={betaMode}
 />
 <p className="text-[10px] text-[#8A8A7C] font-mono mt-1 ml-1">* CASE SENSITIVE ALPHANUMERIC</p>
 </div>
 )}

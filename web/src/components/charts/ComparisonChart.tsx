...
export function ComparisonChart({ traders }: ComparisonChartProps) {
 ...
 <BarChart3 className="w-10 h-10" style={{ color: '#B8912A', opacity: 0.6 }} />
 </div>
 <div className="text-lg font-bold mb-2" style={{ color: '#1E1E1A' }}>
 {t('noHistoricalData', language)}
 </div>
 <div className="text-sm text-center max-w-xs" style={{ color: '#6E6E60' }}>
 ...
 >
 <div className="flex items-center gap-2 mb-3 pb-2" style={{ borderBottom: '1px solid #C0B9A2' }}>
 ...
 <div className="text-[10px] mono" style={{ color: '#8A8A7C' }}>
 ${equity?.toFixed(2)}
 </div>
 </div>
 </div>
 ...
 style={{
 background: idx === 0 ? 'rgba(184, 145, 42, 0.15)' : 'rgba(192, 185, 162, 0.5)',
 ...
 style={{ color: trader.currentPnl >= 0 ? '#2E7D4F' : '#C0392B' }}>
 ...
 style={{ background: 'linear-gradient(180deg, rgba(244, 241, 232, 0.8) 0%, rgba(244, 241, 232, 1) 100%)' }}>
 {/* Watermark */}
 <div style={{
 position: 'absolute',
 top: '50%',
 ...
 <span style={{ color: '#1E1E1A', fontSize: '12px', fontWeight: 500 }}>
 {entry.value}
 <span style={{
 ...
 style={{ background: 'rgba(184, 145, 42, 0.05)', border: '1px solid rgba(184, 145, 42, 0.1)' }}>
 <div className="text-[10px] uppercase tracking-wider mb-1" style={{ color: '#6E6E60' }}>
 {t('leader', language)}
 </div>
 <div className="text-sm font-bold truncate" style={{ color: '#B8912A' }}>
 {leader?.trader_name || '-'}
 </div>
 </div>
 <div className="p-3 rounded-lg text-center" style={{ background: 'rgba(46, 125, 79, 0.05)' }}>
 <div className="text-[10px] uppercase tracking-wider mb-1" style={{ color: '#6E6E60' }}>
 {t('leadPnL', language) || 'Lead PnL'}
 </div>
 <div className="text-sm font-bold mono"
 style={{ color: (leader?.currentPnl || 0) >= 0 ? '#2E7D4F' : '#C0392B' }}>

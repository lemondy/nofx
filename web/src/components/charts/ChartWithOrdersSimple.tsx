...
export function ChartWithOrdersSimple({
 ...
 return (
 <div className="relative" style={{ background: '#F2EFE6', borderRadius: '8px', overflow: 'hidden', minHeight: height }}>
 {/* 标题栏 */}
 ...
 <>
 <div className="p-4 rounded" style={{ background: '#E9E4D6', border: '1px solid #C0B9A2' }}>
 <div className="text-sm mb-2" style={{ color: '#6E6E60' }}>币安K线数据</div>
 ...
 {traderID && (
 <div className="p-4 rounded" style={{ background: '#E9E4D6', border: '1px solid #C0B9A2' }}>
 <div className="text-sm mb-2" style={{ color: '#6E6E60' }}>历史订单数据</div>
 <div className="text-2xl font-bold" style={{ color: '#B8912A' }}>
 {orderCount} 笔订单
 </div>
 </div>
 )}
 ...
 <div className="p-4 rounded" style={{ background: '#E9E4D6', border: '1px solid #C0B9A2' }}>
 <div className="text-sm mb-2" style={{ color: '#6E6E60' }}>状态</div>

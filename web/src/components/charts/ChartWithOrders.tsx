...
export function ChartWithOrders({
 ...
 return (
 <div className="relative" style={{ background: '#F2EFE6', borderRadius: '8px', overflow: 'hidden' }}>
 {/* Title bar */}
 <div className="flex items-center justify-between p-4" style={{ borderBottom: '1px solid #C0B9A2' }}>
 ...
 >
 <div style={{ marginBottom: '6px', color: '#B8912A', fontWeight: 'bold', fontSize: '11px' }}>
 ...
 <span style={{ color: '#1E1E1A', fontWeight: '500' }}>{tooltipData.open?.toFixed(2)}</span>

 <span style={{ color: '#6E6E60' }}>H:</span>
 <span style={{ color: '#2E7D4F', fontWeight: '500' }}>{tooltipData.high?.toFixed(2)}</span>

 <span style={{ color: '#6E6E60' }}>L:</span>
 <span style={{ color: '#C0392B', fontWeight: '500' }}>{tooltipData.low?.toFixed(2)}</span>

 <span style={{ color: '#6E6E60' }}>C:</span>
 <span style={{
 color: tooltipData.close >= tooltipData.open ? '#2E7D4F' : '#C0392B',
 fontWeight: 'bold'
 }}>
 ...
 {/* Legend */}
 <div className="flex items-center gap-4 p-4 text-xs" style={{ borderTop: '1px solid #C0B9A2', color: '#6E6E60' }}>
 <div className="flex items-center gap-2">
 <span className="font-bold" style={{ color: '#2E7D4F' }}>B</span>
 <span>{t('chartWithOrders.buy', language)}</span>
 </div>
 <div className="flex items-center gap-2">
 <span className="font-bold" style={{ color: '#C0392B' }}>S</span>

...
export function MetricTooltip({
 ...
 <span style={{ fontWeight: 'bold', fontSize: '14px', color: '#1E1E1A' }}>
 {name}
 </span>
 </div>
 ...
 <div style={{ fontSize: '12px', color: '#6E6E60', marginBottom: '8px' }}>
 {formulaLabel}
 </div>
 <div style={{
 display: 'flex',
 ...
 {/* Description */}
 <p style={{ fontSize: '12px', lineHeight: '1.5', color: '#6E6E60', margin: 0 }}>
 {description}
 </p>
 </div>
 </div>

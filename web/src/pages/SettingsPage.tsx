...
export function SettingsPage() {
 ...
 return (
 <div className="min-h-screen pt-20 pb-12 px-4" style={{ background: '#F2EFE6' }}>
 ...
 <p className="text-sm text-[#1E1E1A] font-medium">{user?.email}</p>
 </div>
 ...
 <p className="text-sm font-medium text-[#1E1E1A]">{model.name}</p>
 <p className="text-xs text-[#6E6E60]">{model.provider}</p>
 </div>
 </div>
 <div className="flex items-center gap-2">
 <span className={`text-xs px-2 py-0.5 rounded-full ${model.enabled ? 'bg-emerald-500/10 text-emerald-400' : 'bg-[#C0B9A2] text-[#6E6E60]'}`}>
 {model.enabled ? 'Active' : 'Inactive'}
 </span>
 <Pencil size={14} className="text-[#8A8A7C] group-hover:text-[#6E6E60] transition-colors" />
 </div>
 </button>
 ))}
 </div>
 ...
 <div className="text-left">
 <p className="text-sm font-medium text-[#1E1E1A]">{exchange.account_name || exchange.name}</p>
 <p className="text-xs text-[#6E6E60] capitalize">{exchange.exchange_type || exchange.type}</p>
 </div>
 </div>
 <ChevronRight size={14} className="text-[#8A8A7C] group-hover:text-[#6E6E60] transition-colors" />
 </button>
 ))}
 </div>
 )}
 ...
 <span className="text-sm font-medium text-[#1E1E1A]">Configure Telegram Bot</span>
 </div>
 <ChevronRight size={14} className="text-[#8A8A7C] group-hover:text-[#6E6E60] transition-colors" />
 </button>
 </div>

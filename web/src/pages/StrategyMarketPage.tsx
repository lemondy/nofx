...
export function StrategyMarketPage() {
 ...
 <div>
 <h1 className="text-4xl font-bold tracking-tighter text-[#1E1E1A] uppercase glitch-text" data-text={tr('title')}>
 {tr('title')}
 </h1>
 ...
 <p className="text-[#8A8A7C] text-xs tracking-wide uppercase">{tr('noStrategiesDesc')}</p>
 </div>
 )}
 ...
 <span className="text-[#8A8A7C] uppercase">{tr('author')}</span>
 <span className="text-[#6E6E60] group-hover:text-[#1E1E1A] transition-colors">@{strategy.author_email?.split('@')[0] || 'UNKNOWN'}</span>
 </div>
 <div className="flex flex-col text-right">
 <span className="text-[#8A8A7C] uppercase">{tr('createdAt')}</span>
 <span className="text-[#6E6E60]">{formatDate(strategy.created_at)}</span>
 </div>
 </div>
 ...
 )) : <span className="text-[9px] text-[#8A8A7C]">NO_INDICATORS</span>}
 </div>
 ...
 <div className="flex flex-col">
 <span className="text-[#8A8A7C] scale-90 origin-left">LEV</span>
 <span className="text-[#3A3A32] font-bold">{strategy.config.risk_control.btc_eth_max_leverage || '-'}x</span>
 </div>
 <div className="flex flex-col">
 <span className="text-[#8A8A7C] scale-90 origin-left">POS</span>
 <span className="text-[#3A3A32] font-bold">{strategy.config.risk_control.max_positions || '-'}</span>
 </div>
 </div>
 <Activity size={12} className="text-[#8A8A7C]" />
 </div>
 )}
 </div>
 ) : (
 ...
 <button disabled className="w-full py-2.5 text-[10px] font-bold font-mono uppercase tracking-widest border border-[#C0B9A2] bg-[#F2EFE6] text-[#8A8A7C] cursor-not-allowed flex items-center justify-center gap-2">
 <Shield size={12} />
 {tr('hideConfig')}
 </button>
 )}
 ...
 <div className="text-sm font-bold text-[#1E1E1A] uppercase tracking-wider group-hover:text-nofx-gold transition-colors">{tr('shareYours')}</div>
 <div className="text-[10px] text-[#6E6E60] font-mono">CONTRIBUTE TO THE GLOBAL DATABASE</div>
 </div>

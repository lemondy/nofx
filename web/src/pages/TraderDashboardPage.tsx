...
export function TraderDashboardPage({
 ...
 style={{
 background: 'linear-gradient(135deg, rgba(244, 241, 232, 0.6) 0%, rgba(244, 241, 232, 0.4) 100%)',
 }}
 >
 ...
 color: selectedTrader.ai_model.includes('qwen') ? '#c084fc' : '#5e7a5e',
 ...
 <span style={{ color: '#C0392B' }}>{t('traderDashboard.accountFetchFailed', language)}</span>
 ) : (
 <div className="flex gap-4">
 ...
 style={{ textShadow: pos.unrealized_pnl >= 0 ? '0 0 10px rgba(46,125,79,0.3)' : '0 0 10px rgba(192,57,43,0.3)' }}
 >

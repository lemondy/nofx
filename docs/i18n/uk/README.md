...
| Функція | Опис |
|:--------|:------------|
| **Мульти-AI** | DeepSeek, Qwen, GPT, Claude, Gemini, Grok, Kimi, MiniMax, GLM — перемикання будь-коли |
...
| <img src="../../../web/public/icons/glm.svg" width="20" height="20" style="vertical-align: middle;"/> **GLM** | ✅ | [Отримати](https://open.bigmodel.cn) |

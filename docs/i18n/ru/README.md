...
| Функция | Описание |
|:--------|:------------|
| **Мульти-AI** | DeepSeek, Qwen, GPT, Claude, Gemini, Grok, Kimi, MiniMax, GLM — переключение в любой момент |
...
| <img src="../../../web/public/icons/glm.svg" width="20" height="20" style="vertical-align: middle;"/> **GLM** | ✅ | [Получить](https://open.bigmodel.cn) |

...
| 機能 | 説明 |
|:--------|:------------|
| **マルチ AI** | DeepSeek, Qwen, GPT, Claude, Gemini, Grok, Kimi, MiniMax, GLM — いつでも切替 |
...
| <img src="../../../web/public/icons/glm.svg" width="20" height="20" style="vertical-align: middle;"/> **GLM** | ✅ | [API キー取得](https://open.bigmodel.cn) |

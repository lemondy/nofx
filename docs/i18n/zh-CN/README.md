...
| 功能 | 描述 |
|:--------|:------------|
| **多 AI** | DeepSeek、Qwen、GPT、Claude、Gemini、Grok、Kimi、MiniMax、GLM — 随时切换 |
...
| <img src="../../../web/public/icons/glm.svg" width="20" height="20" style="vertical-align: middle;"/> **GLM** | ✅ | [获取 API Key](https://open.bigmodel.cn) |

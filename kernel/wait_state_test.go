...
func TestWaitStateHygiene(t *testing.T) {
	...
	if err := validateDecision(&d, 52, 10, 5, 10, 1.5); err != nil {
	...
	if err := validateDecision(&d2, 52, 10, 5, 10, 1.5); err != nil {
	...
	if err := validateDecision(&d3, 52, 10, 5, 10, 1.5); err != nil {
	...
	if err := validateDecision(&d4, 52, 10, 5, 10, 1.5); err != nil {
	...
	if err := validateDecision(&d5, 52, 10, 5, 10, 1.5); err != nil {
	...
	if err := validateDecision(&d6, 52, 10, 5, 10, 1.5); err != nil {
